import { MessageSquare, TrendingUp, Settings, LogOut, Users } from "lucide-react";
    ...
    <aside className="w-64 bg-sidebar border-r border-border flex flex-col">
      ...
      <div className="p-4">
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-lg text-sidebar-foreground hover:bg-destructive/10 transition-colors w-full text-left"
        >
